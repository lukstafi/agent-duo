---
name: duo-suggest-refactor
description: Agent-duo suggest-refactor phase - reflect on what you'd do differently
metadata:
  short-description: Write refactoring suggestions after PR merge
---

# Agent Duo - Suggest Refactor Phase
...
```bash
cat > "$PEER_SYNC/suggest-refactor-$MY_NAME.md" << 'SUGGESTIONS_EOF'
# Refactoring Suggestions from $MY_NAME
...
```bash
agent-duo signal "$MY_NAME" suggest-refactor-done "wrote refactoring suggestions"
```
