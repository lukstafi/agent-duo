---
name: duo-integrate
description: Agent-duo integrate phase for rebasing onto updated main
metadata:
  short-description: Rebase your branch onto updated main
---

# Agent Duo - Integrate Phase
...
```bash
agent-duo signal "$MY_NAME" integrate-done "rebased onto main"
```
...
git fetch origin
git reset --hard origin/$FEATURE-$MY_NAME

# Try again or signal for help
agent-duo signal "$MY_NAME" integrate-done "rebase failed, needs manual intervention"
```
